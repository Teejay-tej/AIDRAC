...
<div className='aboutus'>
        ...
        <div className='card3'>
                ...
                <div className='div2'>
               <img id="pic"src={aadhaarpic} alt="aadhaarfyp" width={"70%"} height={"500px"}/>
                </div>
        </div>
...
`}
            ...
            <div className='div2link'>
                    <div id='link1' onClick={() => openInNewTab('https://i.postimg.cc/vHc54m5k/Untitled-Diagram.png')}>
                        <p id="linktext">Check out our system architecture here </p>
                        <br/><br/><br/><br/>
                        <img src={arrow} alt="arrow" width={"25px"}/> 
                    </div>
                    <div id='link2' onClick={() => openInNewTab('https://i.postimg.cc/vHc54m5k/Untitled-Diagram.png')}>
